...
configuration_options =
{
	...
	},
	{
		name = "ro_bin",
		label = "Ro Bin",
		hover = "Enables Ro Bin as special drop of Toadstoool.",
		options =
		{
			{description = "Enabled", 
			hover = "100% Drop rate from Toadstoool.",
			data = 1.00},
			{description = "90% Chance", 
			hover = "90% Drop rate from Toadstoool.",
			data = 0.90},
			{description = "80% Chance", 
			hover = "80% Drop rate from Toadstoool.",
			data = 0.80},
			{description = "70% Chance", 
			hover = "70% Drop rate from Toadstoool.",
			data = 0.70},
			{description = "60% Chance", 
			hover = "60% Drop rate from Toadstoool.",
			data = 0.60},
			{description = "50% Chance", 
			hover = "50% Drop rate from Toadstoool.",
			data = 0.50},
			{description = "40% Chance", 
			hover = "40% Drop rate from Toadstoool.",
			data = 0.40},
			{description = "30% Chance", 
			hover = "30% Drop rate from Toadstoool.",
			data = 0.30},
			{description = "20% Chance", 
			hover = "20% Drop rate from Toadstoool.",
			data = 0.20},
			{description = "10% Chance", 
			hover = "10% Drop rate from Toadstoool.",
			data = 0.10},
			{description = "Disabled", 	
			hover = "Default Toadstoool loot.",
			data = 0.00},
		},
		default = 0.00,
	},
