...
local BIRD_TYPES =
{
	...
	[GROUND.LAWN] = { "pigeon" },
	[GROUND.COBBLEROAD] = { "pigeon" },
	[GROUND.FOUNDATION] = { "pigeon" },
	-- Gorge Birds --
	[GROUND.PINKSTONE] = { "quagmire_pigeon" },
	[GROUND.PINKPARK] = { "quagmire_pigeon" },
	[GROUND.STONECITY] = { "quagmire_pigeon" },
	[GROUND.GREYFOREST] = { "quagmire_pigeon" },
	[GROUND.BROWNCARPET] = { "quagmire_pigeon" },
	-- Shipwrecked Birds --
	[GROUND.BEACH] = { "toucan", "parrot", "parrot_pirate", "seagull" }, 
	[GROUND.JUNGLE] = { "toucan", "parrot", "parrot_pirate" },
	[GROUND.MEADOW] = { "toucan", "parrot" },
	[GROUND.TIDALMARSH] = { "toucan", "parrot", "parrot_pirate" },
	
    [GROUND.OCEAN_COASTAL] = { "puffin", "seagull", "cormorant" },
    [GROUND.OCEAN_COASTAL_SHORE] = { "puffin", "seagull", "cormorant" },
    [GROUND.OCEAN_SWELL] = { "puffin", "seagull", "cormorant" },
    [GROUND.OCEAN_ROUGH] = { "puffin", "seagull", "cormorant" },
    [GROUND.OCEAN_BRINEPOOL] = { "puffin", "seagull", "cormorant" },
    [GROUND.OCEAN_BRINEPOOL_SHORE] = { "puffin", "seagull", "cormorant" },
    [GROUND.OCEAN_HAZARDOUS] = { "puffin", "seagull", "cormorant" },
}
