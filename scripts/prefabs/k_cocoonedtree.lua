...
local builds =
{
	normal = {
		...
		prefab_name="cocoonedtree",
		normal_loot = {"log", "log", "burr", "silk"},
		short_loot = {"log", "silk"},
		tall_loot = {"log", "log", "log", "burr", "burr", "silk"},
	}
}
...
tree("cocoonedtree_normal", "normal", 2),
tree("cocoonedtree_tall", "normal", 3),
