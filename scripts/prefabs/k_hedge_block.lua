...
function MakeHedgeType(data)
    ...
    return Prefab("hedge_block", fn, assets, prefabs),
        Prefab("hedge_block_item", itemfn, assets, {"hedge_block_item_placer", "collapse_small"}),
		MakePlacer("hedge_block_item_placer", "hedge", "hedge1_build", "growth1", false, false, true, nil, nil, "eight")
end

local hedgeprefabs = {}
local hedgedata =
{   
    { name = "hedge_block",	hedgetype = 1, material = "grass", tags = { "grass", "hedge" },	loot = "cutgrass", maxloots = 2, maxhealth = TUNING.STONEWALL_HEALTH, buildsound = "dontstarve/common/place_structure_straw" },
}
