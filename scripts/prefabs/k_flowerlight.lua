...
local function single()
	...
	inst.components.workable:SetOnWorkCallback(dig_up_one)
...
local function springy()
	local inst = commonfn("bulb_plant_springy", "bulb_plant_springy", lightparams_single)
...
local function triple()
	...
	inst.components.workable:SetOnWorkCallback(dig_up_three)
