...
local firelevels =
{
    ...
    {anim="level4", sound="dontstarve/common/campfire", radius=16, intensity=.8, falloff=.33, colour = {255/255,255/255,192/255}, soundintensity=1},
}
...
return Prefab("kyno_obsidianfire", fn, assets, prefabs)