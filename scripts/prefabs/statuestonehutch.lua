...
local assets =
{
    ...
    Asset("MINIMAP_IMAGE", "statuestonehutch"),
}
...
return Prefab("statuestonehutch", fn, assets, prefabs),
	MakePlacer("statuestonehutch_placer", "statuestonehutch", "statuestonehutch", "idle")
