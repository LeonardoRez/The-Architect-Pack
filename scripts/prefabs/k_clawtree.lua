...
return tree("clawtree", "normal", 0),
tree("clawtree_normal", "normal", 2),
tree("clawtree_tall", "normal", 3),
tree("clawtree_short", "normal", 1),
tree("clawtree_burnt", "normal", 0, "burnt"),
tree("clawtree_stump", "normal", 0, "stump")