...
function MakeHedgeType(data)
    ...
    return Prefab("hedge_cone", fn, assets, prefabs),
        Prefab("hedge_cone_item", itemfn, assets, {"hedge_cone_item_placer", "collapse_small"}),
		MakePlacer("hedge_cone_item_placer", "hedge", "hedge2_build", "growth1", false, false, true, nil, nil, "eight")
end

local hedgeprefabs = {}
local hedgedata =
{   
    { name = "hedge_cone",	hedgetype = 1, material = "grass", tags = { "grass", "hedge" },	loot = "cutgrass", maxloots = 2, maxhealth = TUNING.STONEWALL_HEALTH, buildsound = "dontstarve/common/place_structure_straw" },
}
