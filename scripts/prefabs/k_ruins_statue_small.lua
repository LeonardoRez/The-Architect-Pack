...
return Prefab("kyno_statueruins_small_bluegem", bluefn, assets, prefabs),
Prefab("kyno_statueruins_small_redgem", redfn, assets, prefabs),
Prefab("kyno_statueruins_small_purplegem", purplefn, assets, prefabs),
Prefab("kyno_statueruins_small_orangegem", orangefn, assets, prefabs),
Prefab("kyno_statueruins_small_yellowgem", yellowfn, assets, prefabs),
Prefab("kyno_statueruins_small_greengem", greenfn, assets, prefabs),
Prefab("kyno_statueruins_small_nogem", nogemfn, assets, prefabs),
MakePlacer("kyno_statueruins_small_bluegem_placer", "statue_ruins_small", "statue_ruins_small", "idle_full", false, nil, nil, nil, nil, nil, bluegemtest),
MakePlacer("kyno_statueruins_small_redgem_placer", "statue_ruins_small", "statue_ruins_small", "idle_full", false, nil, nil, nil, nil, nil, redgemtest),
MakePlacer("kyno_statueruins_small_purplegem_placer", "statue_ruins_small", "statue_ruins_small", "idle_full", false, nil, nil, nil, nil, nil, purplegemtest),
MakePlacer("kyno_statueruins_small_orangegem_placer", "statue_ruins_small", "statue_ruins_small", "idle_full", false, nil, nil, nil, nil, nil, orangegemtest),
MakePlacer("kyno_statueruins_small_yellowgem_placer", "statue_ruins_small", "statue_ruins_small", "idle_full", false, nil, nil, nil, nil, nil, yellowgemtest),
MakePlacer("kyno_statueruins_small_greengem_placer", "statue_ruins_small", "statue_ruins_small", "idle_full", false, nil, nil, nil, nil, nil, greengemtest),
MakePlacer("kyno_statueruins_small_nogem_placer", "statue_ruins_small", "statue_ruins_small", "idle_full")