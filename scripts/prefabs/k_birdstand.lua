...
local assets =
{
	...
	Asset("IMAGE", "images/minimapimages/kyno_birdstand.tex"),
    Asset("ATLAS", "images/minimapimages/kyno_birdstand.xml"),
...
local function fn()
    ...
    minimap:SetIcon("kyno_birdstand.tex")

    inst.AnimState:SetBank("birdcage")
    inst.AnimState:SetBuild("bird_stand")
...
return Prefab("kyno_birdstand", fn, assets, prefabs),
MakePlacer("kyno_birdstand_placer", "birdcage", "bird_stand", "idle_empty")