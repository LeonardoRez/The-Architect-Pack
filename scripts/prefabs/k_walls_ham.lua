...
function MakeWallType(data)
    ...
    local function itemfn()
		...
		inst.components.repairer.repairmaterial = data.name == "pig_ruins" and MATERIALS.THULECITE or data.name
    ...
    local function fn()
        ...
        inst.components.repairable.repairmaterial = data.name == "pig_ruins" and MATERIALS.THULECITE or data.name
...
local walldata =
{   
    { name = "pig_ruins",	material = "thulecite", tags = { "stone", "ruins" },	loot = "rocks", "thulecite_pieces", maxloots = 2, maxhealth = TUNING.RUINSWALL_HEALTH,	buildsound = "dontstarve/common/place_structure_stone" },
}
