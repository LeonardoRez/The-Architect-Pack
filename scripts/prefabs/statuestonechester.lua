...
local assets =
{
	...
	Asset("ANIM", "anim/statuestonechester.zip"),
    Asset("MINIMAP_IMAGE", "statuestonechester"),
}
...
SetSharedLootTable( 'statuestonechester',
{
    {'stone',  1.0},
    {'stone',  0.3},
})
...
local function fn()
    ...
    inst.AnimState:SetBank("statuestonechester")
    inst.AnimState:SetBuild("statuestonechester")
    inst.AnimState:PlayAnimation("idle")

    inst.MiniMapEntity:SetIcon("statuestonechester.png")
    ...
    inst.components.lootdropper:SetChanceLootTable('statuestonechester')
...
return Prefab("statuestonechester", fn, assets, prefabs),
	MakePlacer("statuestonechester_placer", "statuestonechester", "statuestonechester", "idle")
