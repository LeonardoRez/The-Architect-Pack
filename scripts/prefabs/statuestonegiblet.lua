...
local assets =
{
	...
	Asset("ANIM", "anim/statuestonegiblet.zip"),
    Asset("MINIMAP_IMAGE", "statuestonegiblet"),
}
...
SetSharedLootTable( 'statuestonegiblet',
{
    {'stone',  1.0},
    {'stone',  0.3},
})
...
local function fn()
    ...
    inst.AnimState:SetBank("statuestonegiblet")
    inst.AnimState:SetBuild("statuestonegiblet")
    inst.AnimState:PlayAnimation("idle")

    inst.MiniMapEntity:SetIcon("statuestonegiblet.png")
    ...
    inst.components.lootdropper:SetChanceLootTable('statuestonegiblet')
...
return Prefab("statuestonegiblet", fn, assets, prefabs),
	MakePlacer("statuestonegiblet_placer", "statuestonegiblet", "statuestonegiblet", "idle")
