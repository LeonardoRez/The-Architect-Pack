...
local assets =
{
	...
	Asset("ANIM", "anim/statuemarblegiblet.zip"),
    Asset("MINIMAP_IMAGE", "statuemarblegiblet"),
}
...
SetSharedLootTable( 'statuemarblegiblet',
{
    {'marble',  1.0},
    {'marble',  0.3},
})
...
local function fn()
    ...
    inst.AnimState:SetBank("statuemarblegiblet")
    inst.AnimState:SetBuild("statuemarblegiblet")
    inst.AnimState:PlayAnimation("idle")

    inst.MiniMapEntity:SetIcon("statuemarblegiblet.png")
    ...
    inst.components.lootdropper:SetChanceLootTable('statuemarblegiblet')
...
return Prefab("statuemarblegiblet", fn, assets, prefabs),
	MakePlacer("statuemarblegiblet_placer", "statuemarblegiblet", "statuemarblegiblet", "idle")
