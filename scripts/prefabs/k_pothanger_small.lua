...
local function potfn()
	...
	inst.AnimState:SetBank("quagmire_potsmall_hanger")
	inst.AnimState:SetBuild("quagmire_potsmall_hanger")
	...
	inst.components.inspectable.nameoverride = "QUAGMIRE_POT_SMALL"
...
return Prefab("kyno_pothanger_potsmall", potfn, assets, prefabs),
MakePlacer("kyno_pothanger_potsmall_placer", "quagmire_potsmall_hanger", "quagmire_potsmall_hanger", "idle_loop", false, nil, nil, nil, nil, nil, potplacetestfn)