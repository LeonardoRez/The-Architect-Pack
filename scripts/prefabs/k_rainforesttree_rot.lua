...
local builds =
{
	normal = {
		...
		normal_loot = {"log", "log", "burr", "spoiled_food"},
		short_loot = {"log", "spoiled_food"},
		tall_loot = {"log", "log", "log", "burr", "spoiled_food"},		
	}
}
...
tree("rainforesttree_rot_normal", "normal", 2),
tree("rainforesttree_rot_tall", "normal", 3),
