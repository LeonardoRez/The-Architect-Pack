...
local assets =
{
	...
	Asset("ANIM", "anim/statuemarblehutch.zip"),
    Asset("MINIMAP_IMAGE", "statuemarblehutch"),
}
...
SetSharedLootTable( 'statuemarblehutch',
{
    {'marble',  1.0},
    {'marble',  0.3},
})
...
local function fn()
    ...
    inst.AnimState:SetBank("statuemarblehutch")
    inst.AnimState:SetBuild("statuemarblehutch")
    inst.AnimState:PlayAnimation("idle")

    inst.MiniMapEntity:SetIcon("statuemarblehutch.png")
    ...
    inst.components.lootdropper:SetChanceLootTable('statuemarblehutch')
...
return Prefab("statuemarblehutch", fn, assets, prefabs),
	MakePlacer("statuemarblehutch_placer", "statuemarblehutch", "statuemarblehutch", "idle")
