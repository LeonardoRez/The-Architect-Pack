...
local assets =
{
	...
	Asset("ANIM", "anim/statuestoneewelet.zip"),
    Asset("MINIMAP_IMAGE", "statuestoneewelet"),
}
...
SetSharedLootTable( 'statuestoneewelet',
{
    {'stone',  1.0},
    {'stone',  0.3},
})
...
local function fn()
    ...
    inst.AnimState:SetBank("statuestoneewelet")
    inst.AnimState:SetBuild("statuestoneewelet")
    inst.AnimState:PlayAnimation("idle")

    inst.MiniMapEntity:SetIcon("statuestoneewelet.png")
    ...
    inst.components.lootdropper:SetChanceLootTable('statuestoneewelet')
...
return Prefab("statuestoneewelet", fn, assets, prefabs),
	MakePlacer("statuestoneewelet_placer", "statuestoneewelet", "statuestoneewelet", "idle")
