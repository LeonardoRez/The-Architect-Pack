...
local assets =
{
	...
	Asset("IMAGE", "images/inventoryimages/kyno_nectarchest.tex"),
	Asset("ATLAS", "images/inventoryimages/kyno_nectarchest.xml"),
...
return Prefab("kyno_nectarchest", fn, assets, prefabs),
MakePlacer("kyno_nectarchest_placer", "ant_chest", "ant_chest_nectar", "closed")