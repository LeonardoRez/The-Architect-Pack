...
local function addcoconut(name, spawn_prefab, bank, build, anim, winter_tree)
    local assets =
    {
    ...
    table.insert(coconuts, Prefab(name, fn, assets, prefabs))
    table.insert(coconuts, MakePlacer(name.."_placer", bank, build, anim))
end

addcoconut("coconut", "kyno_palmtree_sapling", "coconut", "coconut", "planted")
