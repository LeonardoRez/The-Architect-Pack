...
{
	normal = {
		file="claw_tree_build2",
		prefab_name="clawtree2",
...
return tree("clawtree2", "normal", 0),
tree("clawtree2_normal", "normal", 2),
tree("clawtree2_tall", "normal", 3),
tree("clawtree2_short", "normal", 1),
tree("clawtree2_burnt", "normal", 0, "burnt"),
tree("clawtree2_stump", "normal", 0, "stump")