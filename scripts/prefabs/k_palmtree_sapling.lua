...
local function sapling_fn(build, anim, growprefab, tag, fireproof, overrideloot)
    local function fn()
        ...
        inst.growprefab = "palmtree_short"
...
return Prefab("kyno_palmtree_sapling", sapling_fn("coconut", "planted", "palmtree_short", "palmtree", true), pinecone_assets, pinecone_prefabs)