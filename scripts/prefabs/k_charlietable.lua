...
local function onworked(inst, worker)
    -- make sure it never runs out of work to do -- Kynoox: NO! HAHAHAHA
...
return Prefab("kyno_stagehand", fn, assets, prefabs),
MakePlacer("kyno_stagehand_placer", "stagehand", "stagehand", "idle")