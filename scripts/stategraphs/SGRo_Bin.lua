...
local states=
{
    ...
    State{
        ...
        events=
        {
         ...
         timeline=             
        {   
            TimeEvent(5*FRAMES, function(inst) inst.SoundEmitter:PlaySound("dontstarve_DLC003/creatures/ro_bin/close") end),
            TimeEvent(9*FRAMES, function(inst) inst.SoundEmitter:PlaySound("dontstarve/wilson/cook", nil, .6) end),
        },
   },
    State{
        name = "death",
...
CommonStates.AddSleepStates(states,
{
    ...
    sleeptimeline = 
    {
         -- TimeEvent(10*FRAMES, function(inst) inst.SoundEmitter:PlaySound("eruditesounds/sounds/robinsleepout", "sleepout") inst.SoundEmitter:SetVolume("sleepout", .2) end),
         -- TimeEvent(30*FRAMES, function(inst) inst.SoundEmitter:PlaySound("eruditesounds/sounds/robinsleepin", "sleepin") inst.SoundEmitter:SetVolume("sleepin", .2) end),
         -- TimeEvent(40*FRAMES, function(inst) inst.SoundEmitter:PlaySound("eruditesounds/sounds/robinsleepout", "sleepout") inst.SoundEmitter:SetVolume("sleepout", .2) end),
         -- TimeEvent(60*FRAMES, function(inst) inst.SoundEmitter:PlaySound("eruditesounds/sounds") end),
    },
    waketimeline = 
    {
        TimeEvent(0*FRAMES, function(inst) inst.SoundEmitter:PlaySound("dontstarve_DLC003/creatures/ro_bin/hit") end)
