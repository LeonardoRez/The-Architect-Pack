...
AddRecipe("kyno_gorge_prototyper", {Ingredient("transistor", 2), Ingredient("cutstone", 3), Ingredient("meatballs", 2)},
...
AddRecipe("kyno_doydoy_nest",{Ingredient("twigs", 8), Ingredient("goose_feather", 2), Ingredient("egg", 1)},
